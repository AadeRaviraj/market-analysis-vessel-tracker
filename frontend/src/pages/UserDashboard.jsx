      ...
      <div className="page">
        <div className="page-header">
          <div>
            ...
            <p>View-only access. Data entry is reserved for Office Admins.</p>
          </div>
        </div>

        <div className="locked-note">
          You're signed in as an Office User — you can view region-wise and aggregated
          performance, but data entry is disabled for your role.
        </div>
        ...
        {tab === "region" && (
          <div className="card">
            ...
            <p className="card-sub">
              Daily comparison of market rate vs. hire rate, per region/vessel.
            </p>
        ...
        {tab === "aggregated" && (
          <div className="card">
            ...
            <p className="card-sub">
              Daily average market rate vs. hire rate across all regions.
            </p>
            <div className="filter-row">
              <div className="field">
                <label>From date</label>
